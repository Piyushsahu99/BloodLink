...
2. Send an email to our security team at [security@raktchain.example.com](mailto:security@raktchain.example.com) with the subject line "Security Vulnerability Report - Raktchain".

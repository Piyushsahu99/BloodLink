...
import { FaBars, FaTimes, FaHeartbeat, FaSignOutAlt, FaCubes } from "react-icons/fa";
...
const Navbar = () => {
  ...
  return (
    <nav className="sticky top-0 z-[9999] bg-white/95 backdrop-blur-md text-gray-800 px-6 py-4 shadow-lg border-b border-red-100">
            ...
            {user?.role === 'admin' && (
              <>
                ...
                <li>
                  <Link
                    to="/admin/ledger"
                    className="px-5 py-2.5 rounded-lg font-bold text-sm bg-gradient-to-r from-rose-500 to-pink-500 text-white hover:from-rose-600 hover:to-pink-600 transition-all duration-200 shadow-md flex items-center gap-2"
                  >
                    <FaCubes /> Ledger
                  </Link>
                </li>
            ...
            {user?.role === 'admin' && (
              <>
                ...
                <Link
                  to="/admin/ledger"
                  onClick={() => setIsOpen(false)}
                  className="flex px-4 py-3 rounded-lg font-bold bg-gradient-to-r from-rose-500 to-pink-500 text-white shadow-md items-center gap-2"
                >
                  <FaCubes /> Ledger Console
                </Link>
              </>
            )}
